...
$dbo = new Database();
$staff_id = $new_password = $confirm_password = "";
$error_message = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($staff_id) || empty($new_password) || empty($confirm_password)) {
        ...
        if (!$stmt->fetch()) {
            ...
            try {
                // Update password in the staff_details table
                $updateQuery = "UPDATE staff_details SET password = :password WHERE staff_id = :staff_id";
                $updateStmt = $dbo->conn->prepare($updateQuery);
                $updateStmt->execute([":password" => $hashedPassword, ":staff_id" => $staff_id]);
    ...
    <div class="form-container">
        ...
        <form id="resetForm" action="" method="POST">
            <div class="input-group">
                ...
                <input type="text" id="staff_id" name="staff_id" placeholder="Enter your registration ID" required>
            </div>
